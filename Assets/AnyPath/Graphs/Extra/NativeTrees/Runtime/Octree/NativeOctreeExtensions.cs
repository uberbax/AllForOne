...
namespace AnyPath.NativeTrees
{
    ...
    public static class NativeOctreeExtensions
    {
        ...
        /// <param name="results"></param>
        /// <typeparam name="T"></typeparam>
        public static void RangeAABBUnique<T>(this NativeOctree<T> octree, AABB range, NativeHashSet<T> results) where T : unmanaged, IEquatable<T>
        {
        ...
        {
            public NativeHashSet<T> results;
        ...
        public struct AABBDistanceSquaredProvider<T> : IOctreeDistanceProvider<T> 
        {

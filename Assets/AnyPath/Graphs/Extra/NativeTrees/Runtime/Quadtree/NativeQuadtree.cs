...
namespace AnyPath.NativeTrees
{
    ...
    public partial struct NativeQuadtree<T> : INativeDisposable where T : unmanaged 
    {
        ...
        private NativeReference<AABB2D> bounds;
        private float2 boundsCenter => bounds.Value.Center;
        private float2 boundsExtents => bounds.Value.Size / 2;
        private float2 boundsQuarterSize => bounds.Value.Size / 4;
        ...
        public NativeQuadtree(AABB2D bounds, int objectsPerNode, int maxDepth, Allocator allocator, int initialCapacity = 0)
        {
            ...
            this.bounds = new NativeReference<AABB2D>(bounds, allocator);
        ...
        /// Bounds of the tree
        /// </summary>
        public AABB2D Bounds => bounds.Value;

...
namespace Stui
{
    [CustomEditor(typeof(SpriterInt))]
    public class SpriterIntEditor : Editor
    {
        private GUIStyle _headerStyle;

        private static readonly string _headerLabel = "Spriter Int Variable";

        private static readonly string _componentSummary = $"Use the '{nameof(SpriterInt.Value)}' property of this " +
            $"component in your scripts to read this variable's current value.  The '{nameof(SpriterInt.Value)}' " +
        ...
        private static readonly GUIContent _variableNameContent = new GUIContent(
            text: "Variable Name",
            tooltip: "The name of this int variable.  This is defined in the Spriter project.  To change this, " +
        ...
        {
            _variableNameProperty = serializedObject.FindProperty(nameof(SpriterInt.VariableName));;
            _defaultValueProperty = serializedObject.FindProperty(nameof(SpriterInt.DefaultValue));
            _valueProperty = serializedObject.FindProperty(nameof(SpriterInt.Value));
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            {
                EditorGUILayout.ObjectField("Script", MonoScript.FromMonoBehaviour(target as SpriterInt), typeof(SpriterInt), false);
                EditorGUILayout.Space();
